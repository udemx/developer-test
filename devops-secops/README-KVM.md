...
### Linux "VPS" beállítása [KVM](https://www.linux-kvm.org/page/Main_Page) környezetben
A cél egy debian alapú szerver kialakítása *KVM* környezetben.
...
**A KVM adatfájlok feltöltése** (a forrás mappát levélben küldjük ki):

  * `*virsh XML` - KVM Machine settings file.
  * `*qcow2` - KVM disk image file
